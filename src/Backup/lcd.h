...
void battericon()
{
  ...
  float voltage = 5; // analogRead(39) / 4096.0 * 3.7;

  int positionnew = tft.width() - 41;
  int positionnewx = 9;
  ...
  tft.fillRect(tft.width() - 8, 14, 3, 7, 0x0000); // mini rectangle
  if (voltage == 5)
  {
    tft.fillRect(positionnew, positionnewx, 32, 16, ST7735_GREEN);
    tft.fillTriangle(tft.width() - 38, 16, tft.width() - 24, 16, tft.width() - 24, 22, ST7735_YELLOW);
    tft.fillTriangle(tft.width() - 13, 16, tft.width() - 28, 16, tft.width() - 28, 11, ST7735_YELLOW);
  }

  else if (voltage > 3.3)
  {
    tft.fillRect(positionnew, positionnewx, 32, 16, 0xFFFF);
  }
  else if (voltage > 2.5 && voltage <= 3.3)
  {
    tft.fillRect(positionnew, positionnewx, 25, 16, 0xFFFF);
  }
  else if (voltage > 2 && voltage <= 2.5)
  {
    tft.fillRect(positionnew, positionnewx, 20, 16, 0xFFFF);
  }

  else if (voltage > 1.5 && voltage <= 2)
  {
    tft.fillRect(positionnew, positionnewx, 15, 16, 0xFFFF);
  }
  else if (voltage > 1 && voltage <= 1.5)
  {
    tft.fillRect(positionnew, positionnewx, 10, 16, 0xFFFF);
  }
  else if (voltage > 0.5 && voltage <= 1)
  {
    tft.fillRect(positionnew, positionnewx, 5, 16, 0xFFFF);
  }
  else if (voltage > 0 && voltage <= 0.5)
  {
    tft.fillRect(positionnew, positionnewx, 2, 16, 0xFFFF);
  }
}
...
void WiFiIcon()
{
  ...
  tft.drawBitmap(50, 50, wififull, 40, 40, Display_Color_Black);
  int RectStroke1 = 18;
  int RectStroke2 = 13;
  int RectStroke3 = 8;
  int RectRoundi = 8;
  ...
  {
    tft.drawCircle(60, 27, 3, 0x0000);
    tft.drawRoundRect(53, RectStroke1, 15, 5, RectRoundi, 0x0000);
    tft.drawRoundRect(49, RectStroke2, 22, 5, RectRoundi, 0x0000);
    tft.drawRoundRect(45, RectStroke3, 29, 5, RectRoundi, 0x0000);

    tft.fillCircle(60, 27, 2, 0x8431);
    tft.fillRoundRect(54, 19, 13, 3, RectRoundi, 0x8431);
    tft.fillRoundRect(50, 14, 20, 3, RectRoundi, 0x8431);
    tft.fillRoundRect(46, 9, 27, 3, RectRoundi, 0x8431);
  }
  else if (WiFi.status() == WL_CONNECTED)
  {
    ...
    tft.fillCircle(60, 27, 2, 0x2728);
    tft.fillRoundRect(54, 19, 13, 3, RectRoundi, 0x2728);
    tft.fillRoundRect(50, 14, 20, 3, RectRoundi, 0x2728);
    tft.fillRoundRect(46, 9, 27, 3, RectRoundi, 0x2728);
  }
  else if (WiFi.status() == WL_DISCONNECTED)
  {
    ...
    tft.fillCircle(60, 27, 2, 0xd8c2);
    tft.fillRoundRect(54, 19, 13, 3, RectRoundi, 0xd8c2);
    tft.fillRoundRect(50, 14, 20, 3, RectRoundi, 0xd8c2);
    tft.fillRoundRect(46, 9, 27, 3, RectRoundi, 0xd8c2);
  }
}
